...
<div class="page-body">
    <div class="card">
        ...
        <div class="mx-3 mb-3" style="margin-top:-25px !important" jus>
            ...
            <div>
                <form method="post"
                    action="{{ route('gallery.update', $gallery->gallery_id) }}" id="myForm"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="file" class="form-control" id="image" value = "{{$gallery->image}}" name="image">
                            <img width="100px" height="100px" class="mt-2"
                            src="{{asset('storage/'.$gallery->image) }}">
                        </div>
                    </div>
                    <a type="button" class="btn btn-primary btn-outline-primary"
                        href="{{route('gallery.index')}}">back</a>
